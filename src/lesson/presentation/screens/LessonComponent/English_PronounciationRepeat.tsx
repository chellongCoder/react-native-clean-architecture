 ...
 * />
 */
const English_PronounciationRepeat = observer(
  forwardRef<LessonRef, Props>(
    (
      ...
      const answers = useMemo(() => {
        const answer = firstMiniTestTask?.question?.[moduleIndex]?.answers;
                ...
                <View style={[styles.wrapper]}>
                  {answers.map(item => (
                    <View style={styles.answers}>
                      <Text
                        style={[[styles.fonts_SVN_Cherish, styles.txtWhite]]}>
                        {item}
                      </Text>
                    </View>
                  ))}
...
export default English_PronounciationRepeat;
...
const styles = StyleSheet.create({
  ...
  answers: {
    ...
    padding: scale(8),
    backgroundColor: COLORS.GREEN_4CB572,
