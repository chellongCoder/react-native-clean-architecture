...
const Science_SelectAnswer_AnswerMeaning = observer(
            ...
            answerIndex !== -1 ? (
              <Animated.View
                ...
                <FastImage
                  ...
                  resizeMode="contain"
                  style={styles.imageMeaning}
                />
                <Text
                  style={[styles.textTitle, {color: settings.backgroundColor}]}>
                  {
...
export default Science_SelectAnswer_AnswerMeaning;
