  ...
  forwardRef<LessonRef, Props>(
    (
      ...
      const {
        ...
        isCorrectAnswer:
          answerSelected.toString().toLocaleLowerCase() ===
          (
              ...
              'answer_pick_one' ? (
                ...
                <CharScramble
                  ...
                  questionStyle={[
                    ...
                    {fontSize: 36, color: COLORS.BLUE_0877B6},
                  ]}
                  answerStyle={[styles.fonts_BorelRegular, {fontSize: 36}]}
                />
              )}
