...
import SelectionLettersQuestion, {
  SelectionLetterQuestionRef,
} from '../../components/SelectionLettersQuestion';
...
const VnG1M6Lesson = observer(
  forwardRef<LessonRef, Props>(
    (
      ...
      const answerRef = useRef<SelectionLetterQuestionRef>();
        ...
        <LessonComponent
          ...
          buildQuestion={
            <View style={{marginTop: verticalScale(20)}}>
              <Text style={[styles.textQuestion, styles.textColor]}>
                {firstMiniTestTask?.question?.[moduleIndex]?.correctAnswer ??
                  ''}
              </Text>
            </View>
              ...
              <View style={styles.wrapHeaderContainer}>
                <View
                  ...
                  <Text
                    ...
                    {i18n.t('lesson.screens.Modules.chooseALigagAsOn')}
                  </Text>
                </View>

                <VoiceButton onPress={onSpeechText} />
              </View>
              <SelectionLettersQuestion
                answer={
