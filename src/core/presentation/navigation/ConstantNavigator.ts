...
export const STACK_NAVIGATOR = {
  ...
  TUTORIAL_NAVIGATOR: 'TUTORIAL_NAVIGATOR',
  ...
  AUTH: {
    ...
    REGISTER_CHILD_SCREEN: 'REGISTER_CHILD_SCREEN',
    LIST_CHILDREN_SCREEN: 'LIST_CHILDREN_SCREEN',
  ...
  PARENT: {
    ...
    AUTH_PARENT_SCREEN: 'AUTH_PARENT_SCREEN',
    MORE_MODULE_SCREEN: 'MORE_MODULE_SCREEN',
    CHECKOUT_SCREEN: 'CHECKOUT_SCREEN',
    PURCHASE_SUCCESS_SCREEN: 'PURCHASE_SUCCESS_SCREEN',
    PURCHASE_FAILED_SCREEN: 'PURCHASE_FAILED_SCREEN',
  },
  /** ACHIEVEMENT */
  ACHIEVEMENT: {
